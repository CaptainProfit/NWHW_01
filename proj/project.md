...
5) Добавить техники безопасности L2 уровня: DHCP snooping,  перевести неактивные порты в состояние доступа и отключить, добавить portfast и BPDU-Guard, отключить DTP где он не нужен,  добавить защиту ARP таблиц.
6) Стоит добавить здравого смысла в мое проектирование